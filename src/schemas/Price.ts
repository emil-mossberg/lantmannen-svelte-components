...
export const PriceSchema = z.object({
    ...
    price_info: z.object({
        ...
        extension_attributes: z.object({
            ...
            lma_customer_price: z.number().optional(),
            lma_customer_price_formatted: z.string().optional(),
            lma_customer_price_is_campaign: z.boolean().optional(),
            lma_vat_percentage: z.number().optional(),
            lma_unit_measure: z.string().optional(),
            lma_valid_price_inc_vat: z.number().optional(),
            lma_valid_price_inc_vat_formatted: z.string().optional(),
            lma_line_amount: z.number().optional(),
            lma_line_amount_inc_vat: z.number().optional(),
            lma_quantity: z.number().optional(),
            lma_price_lookup_done: z.boolean(),
            lma_custom_price_set: z.boolean(),
            lma_campaign_price: z.number().optional(),
            lma_campaign_price_inc_vat: z.number().optional(),
            lma_profix_price: z.number().optional(),
            lma_profix_price_inc_vat: z.number().optional(),
            lma_campaign_payment_terms: z.string().optional(),
            lma_campaign_fixed_due_date: z.string().optional(),
            lma_list_price: z.number().optional(),
            lma_list_price_formatted: z.string().optional().optional(),
            lma_list_price_inc_vat: z.number().optional(),
            lma_list_price_inc_vat_formatted: z.string().optional(),
            lma_is_pallet_discount: z.boolean().optional(),
